...
def Buscar_Empresas_Generales():
    ...
    try:
        ...
        if result:
            ...
            subprocess.Popen(["python", "Configuracion_Generales.py", clave])
...
def Buscar_Empresas():
    ...
    ttk.Button(search_frame, text="Buscar", command=Buscar_Empresas_Generales).grid(
